...
- [x] Task 1.1 (TDD): `?raw` source-contract test for FlagsList — asserts no
...
- [x] Task 1.2 (Green): Remove the three `<th>`s and matching `<td>`s in
...
- [x] Task 1.3: Full gate — `tsc`, `lint`, vitest (`CI=true`), `build`. Update
