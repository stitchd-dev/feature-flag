...
- Future: warehouse-backed event ingestion; multi-armed bandit; N-way (4+) interaction analysis; on-demand interaction recompute (currently 60-min tick only — tracked as `feature-flag-uga`).
