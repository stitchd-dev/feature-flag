...
- [ ] Task: Define `RuleEngineError` enum
...
- [ ] Task: Define `Condition` leaf enum
...
- [ ] Task: Define `ConditionExpr`, `Rule`, `RuleOutput`, `PercentageTarget`,
...
- [ ] Task: Conductor — User Manual Verification 'Core Types & Error Model'
...
- [ ] Task: Equality, inequality, and numeric comparison evaluators
...
- [ ] Task: String operator evaluators
...
- [ ] Task: SemVer comparison evaluators
...
- [ ] Task: Segment membership and cross-flag condition evaluators
...
- [ ] Task: Conductor — User Manual Verification 'Leaf Condition Evaluation'
    (Protocol in workflow.md)
...
- [ ] Task: Recursive `ConditionExpr` evaluator
...
- [ ] Task: Conductor — User Manual Verification 'Composite Expression & Rule
...
- [ ] Task: `PercentageTarget` value resolution
...
- [ ] Task: SipHash-1-3 bucketing and weight range assignment
...
- [ ] Task: Conductor — User Manual Verification 'Percentage Allocation'
    (Protocol in workflow.md)
...
- [ ] Task: Kahn's topological sort + cycle detection
...
- [ ] Task: Multi-flag evaluation orchestrator
...
- [ ] Task: Conductor — User Manual Verification 'Cross-Flag Dependency
...
- [ ] Task: Wire `rule_engine` module into `stitchd-core` `lib.rs`
...
- [ ] Task: Full coverage and quality gate
...
- [ ] Task: Conductor — User Manual Verification 'Integration & Wiring'
    (Protocol in workflow.md)
