...
mod tests {
    ...
    struct NullAuthUserRepo;
    #[async_trait::async_trait]
    impl stitchd_db::AuthUserRepository for NullAuthUserRepo {
    ...
    struct NullMembershipRepo;
    #[async_trait::async_trait]
    impl stitchd_db::OrgMembershipRepository for NullMembershipRepo {
        async fn add_member(&self, id: stitchd_core::id::UserId, _: OrganisationId, _: stitchd_core::auth::OrgRole) -> Result<stitchd_core::auth::OrgMembership, stitchd_db::RepositoryError> { Err(stitchd_db::RepositoryError::NotFound { id: id.to_string() }) }
        ...
        async fn update_role(&self, id: stitchd_core::id::UserId, _: OrganisationId, _: stitchd_core::auth::OrgRole) -> Result<(), stitchd_db::RepositoryError> { Err(stitchd_db::RepositoryError::NotFound { id: id.to_string() }) }
    }
    struct NullRefreshTokenRepo;
    #[async_trait::async_trait]
    impl stitchd_db::RefreshTokenRepository for NullRefreshTokenRepo {
    ...
    struct NullAuthProviderRepo;
    #[async_trait::async_trait]
    impl stitchd_db::AuthProviderRepository for NullAuthProviderRepo {
        async fn create(&self, _: OrganisationId, _: stitchd_core::auth::ProviderType, _: &str, _: serde_json::Value, _: bool) -> Result<stitchd_core::auth::AuthProvider, stitchd_db::RepositoryError> { Err(stitchd_db::RepositoryError::Unexpected(anyhow::anyhow!("stub"))) }
        ...
        async fn list_for_org(&self, _: OrganisationId) -> Result<Vec<stitchd_core::auth::AuthProvider>, stitchd_db::RepositoryError> { Ok(vec![]) }
    ...
    fn make_test_state() -> AppState {
        ...
        AppState {
            ...
            auth_user_repo: Arc::new(NullAuthUserRepo),
            membership_repo: Arc::new(NullMembershipRepo),
            refresh_token_repo: Arc::new(NullRefreshTokenRepo),
            mfa_repo: Arc::new(NullMfaRepo),
            auth_provider_repo: Arc::new(NullAuthProviderRepo),
